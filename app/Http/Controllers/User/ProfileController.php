...
//        }
    ...
    public function updateWithdrawalInfo(Request $request)
    {
        ...
        $response = Http::withHeaders([
            "Authorization" => "Bearer " . Config::where("key", "paystack_secret_key")->first()->value,
            "Content-Type" => "application/json"
        ])->get(Config::where("key", "paystack_payment_url")->first()->value . "/bank/resolve/",
            [
