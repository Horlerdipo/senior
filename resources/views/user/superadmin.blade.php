                                ...
                                <div class="card card-bordered card-full">
                                    <div class="card-inner p-0 border-top">
                                        <div class="nk-tb-list nk-tb-orders">
                                            ...
                                            @foreach($superadmin as $count=>$superadmins)
                                                <div class="nk-tb-item">
                                                    <div class="nk-tb-col">
                                                        <span class="tb-lead">{{$count+1}}</span>
                                                    </div>
                                                    <div class="nk-tb-col">
                                                        <span class="tb-lead">{{$superadmins->name}}</span>
                                                    </div>
                                                    <div class="nk-tb-col tb-col-sm">
                                                        <span class="tb-sub">{{$superadmins->email}}</span>
                                                    </div>

                                                    <div class="nk-tb-col tb-col-xl">
                                                        <span class="tb-sub">{{db_to_human_time($superadmins->created_at)}}</span>
                                                    </div>

                                                    <div class="nk-tb-col tb-col-xl">
                                                        <a href="{{route("user.delete",$superadmins->id)}}"><span class="tb-sub">Delete</span></a>
                                                    </div>
                ...
                <div class="modal-body">
                    <form action="{{route('create.user')}}" method="POST" class="form-validate form is-alter" id="form">
                        <div class="form-group">
                            <label class="form-label" for="name">Super Admin Name</label>
                        ...
                        @csrf
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-primary btn-submit">Add Super Admin</button>
                        </div>
