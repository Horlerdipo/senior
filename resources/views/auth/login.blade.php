                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="brand-logo pb-4 text-center">
                           ...
                           <h3>Senior Citizen Web Based Profiling System</h3>
                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Senior Citizen Profiling System panel using your email and password.</p>
                                        </div>
                                    </div>
                                </div>
                                <form action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus id="default-01" placeholder="Enter your email address ">
                                        @error('email')
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; <?php echo date("Y") ?> Senior Citizen Web Based Profiling System. Supervised By Dr Omotosho</p>
                                    </div>
                                </div>
                            </div>
                        </div>
