                            ...
                            <div class="card card-bordered card-full">
                                <div class="card-inner">
                                    <div class="card-title-group">
                                        <div class="card-title">
                                            <h6 class="title"><span class="mr-2">All Users</span></h6>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @foreach($user as $count=>$users)
                                            <div class="nk-tb-item">
                                                ...
                                                <div class="nk-tb-col tb-col-md">
                                                    <span class="tb-sub">{{$users->email}}</span>
                                                </div>
                                                <?php
                                                $role=$users->roles->pluck('name')->first();
                                                ...
                                                <div class="nk-tb-col">
                                                    <span class="tb-sub tb-amount"><span>{{db_to_human_time($users->created_at)}}</span></span>
                                                </div>
